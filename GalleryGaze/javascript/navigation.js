document.addEventListener('DOMContentLoaded', () => {
  ...
  function toggleSearchBar() {
    if (window.innerWidth <= 768 || window.innerHeight <= 570) return;
  ...
  function toggleFilterMenu() {
      filterMenu.classList.toggle('hidden');
      if (window.innerWidth <= 768 || window.innerHeight <= 570) {
  ...
  function checkResolution() {
    ...
    var isMobileResolution = windowWidth <= 768 || windowHeight <= 570;
